        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 24px 24px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button style={{ padding: "7px 14px", borderRadius: 6, border: `1px solid ${C.border}`, background: C.elevated, color: C.textSec, fontSize: 11, cursor: "pointer" }}>📊 P&L Report</button>
            </div>
          </div>
                ...
                {PENDING_APPROVALS.map(a => (
                  <div key={a.id} style={{ padding: "10px 12px", borderRadius: 8, background: C.elevated, border: `1px solid ${C.border}`, borderLeft: `3px solid ${a.risk === "high" ? C.red : C.amber}` }}>
                    ...
                    <div style={{ display: "flex", gap: 4 }}>
                      <button style={{ padding: "3px 10px", borderRadius: 4, border: "none", background: C.green, color: "#fff", fontSize: 9, fontWeight: 600, cursor: "pointer" }}>Approve</button>
                      <button style={{ padding: "3px 10px", borderRadius: 4, border: `1px solid ${C.border}`, background: "transparent", color: C.textSec, fontSize: 9, cursor: "pointer" }}>Review</button>
                    </div>
                  </div>
                ))}
              </div>
